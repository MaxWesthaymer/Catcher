...
public class ShareAndRate : MonoBehaviour
{
	...
	{
		subject = "Catcher game";
		var currentLang =  Application.systemLanguage.ToString();
		if (currentLang == "Russian")
		{
			body = "Псс... зацени игрулю, я набрал " + PlayerPrefs.GetInt("higscore").ToString("00") + " очков " + 
				"https://play.google.com/store/apps/details?id=com.Room32.Catcher";
		}
		else
		{
			body = "Pss ... check it out I play, I scored  " + PlayerPrefs.GetInt("higscore").ToString("00") + " points " + 
			       "https://play.google.com/store/apps/details?id=com.Room32.Catcher";
		}
	...
	{
		#if UNITY_ANDROID
		Application.OpenURL("https://play.google.com/store/apps/details?id=com.Room32.Catcher"); 
		#endif
	}
